...
class Config:
    ...
    Attributes:
        ...
        device_memory_utilization: Fraction of device memory to utilize.
    ...
    MIN_DEVICE_MEMORY_UTIL: ClassVar[float] = 0.1
    ...
    def gpu_memory_utilization(self) -> float:
        """Backward compatibility property for GPU memory utilization."""
        return self.device_memory_utilization

    @gpu_memory_utilization.setter
    def gpu_memory_utilization(self, value: float) -> None:
        """Backward compatibility setter for GPU memory utilization."""
        self.device_memory_utilization = value
    ...
    def _validate_kvcache_block_size(self) -> None:
        ...
        if self.kvcache_block_size % self.BLOCK_SIZE_DIVISOR != 0:
            raise ValueError(
                ...
                f'Common values: 64, 128, 256, 512, 1024.')
