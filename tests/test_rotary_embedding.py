...
class TestRotaryEmbedding(unittest.TestCase):
    ...
    def test_rope_scaling_linear(self):
        ...
        # We can check cos_sin_cache
        # cache shape: (max_pos, 2*dim)
        ...
        cos_sin_scaled = rope.cos_sin_cache[2]
        cos_sin_orig = rope_orig.cos_sin_cache[1]

        # Use close comparison
        self.assertTrue(torch.allclose(cos_sin_scaled, cos_sin_orig,
                                       atol=1e-5))
