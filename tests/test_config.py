...
class TestConfigValidation:
    ...
    def test_device_memory_utilization_valid_range(
        ...
        config = Config(str(temp_minimal_model_dir), device_memory_utilization=0.5)
    ...
    def test_tensor_parallel_size_too_high(self, temp_minimal_model_dir: Path) -> None:
    ...
    def test_gpu_memory_utilization_backward_compatibility(
        ...
        config = Config(str(temp_minimal_model_dir), device_memory_utilization=0.7)
